...
export default function Page(): JSX.Element {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    window.location.replace(
      `/mailing?username=${formData.username}&content=${formData.content}&gender=${formData.gender}&inviteLink=${formData.inviteLink}&inviteLinkContent=${formData.inviteLinkContent}&heading=${formData.heading}`
    );
  };
      ...
      <div>
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input
              onChange={handleChange}
              id="inviteLinkContent"
              name="inviteLinkContent"
              required
            />
          </div>
